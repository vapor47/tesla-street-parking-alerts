...
ALTER TABLE "public"."street_sweeping" OWNER TO "postgres";


CREATE OR REPLACE FUNCTION "public"."get_closest_location"("lat" double precision, "long" double precision, "radius_meters" integer) RETURNS SETOF "public"."street_sweeping"
    LANGUAGE "sql" STABLE
    AS $$
  SELECT *
...
ALTER FUNCTION "public"."get_closest_location"("lat" double precision, "long" double precision, "radius_meters" integer) OWNER TO "postgres";
...
CREATE TABLE IF NOT EXISTS "public"."holidays" (
    ...
    "date" "date",
    "holiday" "text",
    "parking_meters_enforced" boolean DEFAULT true,
    "street_sweeping_enforced" boolean DEFAULT true,
    "other_programs_enforced" boolean DEFAULT false
);
...
CREATE TABLE IF NOT EXISTS "public"."parking_regulations" (
    "id" integer NOT NULL,
...
ALTER TABLE "public"."parking_regulations" OWNER TO "postgres";


CREATE SEQUENCE IF NOT EXISTS "public"."parking_regulations_id_seq"
    AS integer
    START WITH 1
    INCREMENT BY 1
    NO MINVALUE
...
ALTER SEQUENCE "public"."parking_regulations_id_seq" OWNER TO "postgres";


ALTER SEQUENCE "public"."parking_regulations_id_seq" OWNED BY "public"."parking_regulations"."id";



CREATE SEQUENCE IF NOT EXISTS "public"."street_sweeping_id_seq"
    AS integer
    START WITH 1
    INCREMENT BY 1
    NO MINVALUE
...
ALTER SEQUENCE "public"."street_sweeping_id_seq" OWNER TO "postgres";


ALTER SEQUENCE "public"."street_sweeping_id_seq" OWNED BY "public"."street_sweeping"."id";



ALTER TABLE ONLY "public"."parking_regulations" ALTER COLUMN "id" SET DEFAULT "nextval"('"public"."parking_regulations_id_seq"'::"regclass");



ALTER TABLE ONLY "public"."street_sweeping" ALTER COLUMN "id" SET DEFAULT "nextval"('"public"."street_sweeping_id_seq"'::"regclass");
...
ALTER TABLE ONLY "public"."parking_regulations"
    ADD CONSTRAINT "parking_regulations_pkey" PRIMARY KEY ("id");



ALTER TABLE ONLY "public"."street_sweeping"
    ADD CONSTRAINT "street_sweeping_pkey" PRIMARY KEY ("id");



CREATE INDEX "idx_street_sweeping_line" ON "public"."street_sweeping" USING "gist" ("line");



CREATE INDEX "parking_regulations_line_idx" ON "public"."parking_regulations" USING "gist" ("line");



CREATE INDEX "street_sweeping_cnn_idx" ON "public"."street_sweeping" USING "btree" ("cnn");



CREATE INDEX "street_sweeping_corridor_idx" ON "public"."street_sweeping" USING "btree" ("corridor");



CREATE INDEX "street_sweeping_line_idx" ON "public"."street_sweeping" USING "gist" ("line");
...
GRANT ALL ON TABLE "public"."street_sweeping" TO "anon";
GRANT ALL ON TABLE "public"."street_sweeping" TO "authenticated";
GRANT ALL ON TABLE "public"."street_sweeping" TO "service_role";



GRANT ALL ON FUNCTION "public"."get_closest_location"("lat" double precision, "long" double precision, "radius_meters" integer) TO "anon";
GRANT ALL ON FUNCTION "public"."get_closest_location"("lat" double precision, "long" double precision, "radius_meters" integer) TO "authenticated";
GRANT ALL ON FUNCTION "public"."get_closest_location"("lat" double precision, "long" double precision, "radius_meters" integer) TO "service_role";
...
GRANT ALL ON TABLE "public"."parking_regulations" TO "anon";
GRANT ALL ON TABLE "public"."parking_regulations" TO "authenticated";
GRANT ALL ON TABLE "public"."parking_regulations" TO "service_role";



GRANT ALL ON SEQUENCE "public"."parking_regulations_id_seq" TO "anon";
GRANT ALL ON SEQUENCE "public"."parking_regulations_id_seq" TO "authenticated";
GRANT ALL ON SEQUENCE "public"."parking_regulations_id_seq" TO "service_role";



GRANT ALL ON SEQUENCE "public"."street_sweeping_id_seq" TO "anon";
GRANT ALL ON SEQUENCE "public"."street_sweeping_id_seq" TO "authenticated";
GRANT ALL ON SEQUENCE "public"."street_sweeping_id_seq" TO "service_role";
